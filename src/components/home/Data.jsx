...
export const Data = () => {
  return (
    <div className="home__data">
        ...
        <p className="home__description">I am a Software Engineer from Bengaluru, India, currently working for International Space Station Program in collabration with NASA.</p>
